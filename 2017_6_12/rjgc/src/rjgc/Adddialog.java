...
public Adddialog(){
		...
		add(lb);add(jt);add(lb2);add(jt2);add(lb3);add(jt3);add(lb4);add(jt4);add(lb5);add(jt5);add(btn);add(btn2);
...
class Enter implements ActionListener{
   ...
   public void actionPerformed(ActionEvent e){
	...
	con.setBackground(Color.green);
			...
			String smajor=jt5.getText();
			Object str[]={sno,sname,ssex,sage,smajor};
